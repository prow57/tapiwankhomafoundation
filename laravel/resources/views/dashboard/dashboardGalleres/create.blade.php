          ...
          <form action="{{ route('dashboardGalleres.store') }}" method="POST" role="form" enctype="multipart/form-data" class="add-new-post">
            ...
            <div class="input-group mb-3">
              <div class="custom-file">
                <input type="file" class="form-control-lg mb-3 custom-file-input" id="customFile2" required="" name="image" onchange="displayFileName()">
                <label class="custom-file-label" for="customFile2" id="customFileLabel">Choose Gallery...</label>
              </div>
            </div>
            <!-- ====================== links Galleres Content Start =============================================== -->
...
function displayFileName() {
  ...
  if (fileInput.files.length > 0) {
    ...
    fileLabel.innerText = 'Choose Gallery...';
  }
}
</script>
@endsection
